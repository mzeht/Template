package com.wpmac.template.model;
...
//    }
    ...
    public static void addUrlList(List<List<AndroidBean>> lists, List<AndroidBean> arrayList, String typeTitle) {
        // title
    ...
    private static AndroidBean getAndroidBean(List<AndroidBean> arrayList, int i, int androidSize) {
    ...
    private static List<AndroidBean> addUrlList(List<AndroidBean> arrayList, int androidSize) {
...
//            DebugUtil.error("---androidSize:  " + androidSize);
     ...
     * 取不同的随机图，在每次网络请求时重置
     */
    private static int getRandom(int type) {
